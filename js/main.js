  ...
  d3.xml(
    ...
    function (error, documentFragment) {
      ...
      if (dataArray != "") {
        ...
        var offsetHeightDevHochregallager =
          document.getElementById("HochregallagerSvg").offsetHeight;
        ...
        var x = d3
          ...
          .range([0, parseFloat(widthLastColumn)])
          .clamp(true); //vlt - 1/10. der länge abziehen wegen rahmen elemente?
        var y = d3
          .scaleLinear()
          .domain([0, parseInt(getDomainMaxRangeHVertikalYScale)])
          .range([
            parseFloat(offsetHeightDevHochregallager) * 0.13,
            parseFloat(offsetHeightDevHochregallager) * 0.65,
          ]);
...
function createSvgSortierstrecke(dataArray) {
  d3.xml("./media/img/Sortierstrecke7.svg", function (error, documentFragment) {
    if (error) {
      console.log(error);
      return;
    }
    ...
    if (
      document.getElementById("SortierstreckeSvg").getElementsByTagName("svg")
        .length == 0
    ) {
      main_chart_svg.node().appendChild(svgNode);
    }
    ...
    if (dataArray != "") {
      ...
      if (
        dataArray[ArrayWithVariablesForSortierstreckeMitFarberkennung[0]] ===
        " false"
      ) {
        svg
          .select("#LichtschrankeEingangSeite")
          .transition()
        ...
        svg
          .select("#LichtschrankeEingangOben")
          .transition()
          .attr("class", "sortierstrecke_Lichtschranke")
          .transition()
          .duration(1000)
      ...
      if (
        dataArray[ArrayWithVariablesForSortierstreckeMitFarberkennung[1]] ===
        " false"
      ) {
        svg
          .select("#LichtschrankeNachFarbsensorSeite")
          .transition()
          .attr("class", "sortierstrecke_Lichtschranke")
          .transition()
          .duration(1000)
          .attr("class", "sortierstrecke_Lichtschranke_transform");
        svg
          .select("#LichtschrankeNachFarbsensorOben")
          .transition()
          .attr("class", "sortierstrecke_Lichtschranke")
          .transition()
          .duration(1000)
      ...
      if (
        dataArray[ArrayWithVariablesForSortierstreckeMitFarberkennung[2]] ===
        " false"
      ) {
        svg
          .select("#LichtschrankeWeissSeite")
          .transition()
          .attr("class", "sortierstrecke_Lichtschranke")
          .transition()
          .duration(1000)
      ...
      if (
        dataArray[ArrayWithVariablesForSortierstreckeMitFarberkennung[3]] ===
        " false"
      ) {
        svg
          .select("#LichtschrankeRotSeite")
          .transition()
          .attr("class", "sortierstrecke_Lichtschranke")
          .transition()
          .duration(1000)
      ...
      if (
        dataArray[ArrayWithVariablesForSortierstreckeMitFarberkennung[4]] ===
        " false"
      ) {
        svg
          .select("#LichtschrankeBlauSeite")
          .transition()
          .attr("class", "sortierstrecke_Lichtschranke")
          .transition()
          .duration(1000)
      ...
      for (id in arraySortierstreckeMitFarberkennungCheckboxIds) {
        ...
        updateInputCheckboxes(
          arraySortierstreckeMitFarberkennungCheckboxIds[id],
          status
        );
      }
    }
